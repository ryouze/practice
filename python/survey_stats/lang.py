...
def lstr(
    ...
    category="",
    language="en",
    return_available_categories=False,
    filename="./input/lang_db.json",
):
    """
...
def translate_pl_to_en(obj, lang_db):
    ...
    logging.info(
        f"ok: translated polish survey to english (rows={obj.shape[0]}, columns={obj.shape[1]})"
    )
    return obj
